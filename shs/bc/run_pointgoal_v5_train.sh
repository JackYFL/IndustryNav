...
TRAIN_OUTPUT="${TRAIN_OUTPUT:-ckpts/astar_pointgoal_pilot_tuned_v5_goalfix}"
EVAL_OUTPUT="${EVAL_OUTPUT:-outputs/astar_pointgoal_pilot_tuned_v5_goalfix_eval}"
TRAIN_EPOCHS="${TRAIN_EPOCHS:-12}"
EVAL_SCENES="${EVAL_SCENES:-4}"
EVAL_BASE_PORT="${EVAL_BASE_PORT:-29800}"

echo "[pointgoal-v5] validating successful A* demonstrations"
...
echo "[pointgoal-v5] training with the corrected Unity-egocentric goal bearing"
...
echo "[pointgoal-v5] evaluating successful held-out expert routes"
