...
#
# Usage:
#   bash shs/gallery/export_scene_gifs.sh
#   TARGET_POSITION=700,180 bash shs/gallery/export_scene_gifs.sh
#   TARGET_POSITION=700,180 bash shs/gallery/export_scene_gifs.sh scene1 scene17
#
# Env:
...
CMD=(
  "$PYTHON_BIN" -m nav.scripts.gallery.validate_scene_gifs
  --file-name "$CLIENT"
